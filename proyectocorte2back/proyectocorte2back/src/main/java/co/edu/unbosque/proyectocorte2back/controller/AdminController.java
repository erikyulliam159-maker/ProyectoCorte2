...
public class AdminController {
	...
	public ResponseEntity<String> create(@RequestParam String username, @RequestParam String password,
			@RequestParam String nombreCompleto, @RequestParam String email, @RequestParam String fotoPerfil) {
		...
		if (status == 0) {
			...
			return new ResponseEntity<>("Error al crear el administrador, puede que el usuario o correo ya esté en uso",
	...
	public ResponseEntity<String> update(@RequestParam Long id, @RequestParam String username,
			@RequestParam String password, @RequestParam String nombreCompleto, @RequestParam String email,
...
//----------------------------------Evento----------------------------------------------------//
	...
	public ResponseEntity<String> createEvento(@RequestBody EventoDTO eventoDTO) {
		...
		if (status == 0) {
			...
			return new ResponseEntity<>("Error al crear el evento, puede que el título ya esté en uso",
					HttpStatus.NOT_ACCEPTABLE);
		}
	}
...
//---------------------------------------------------------------LinkValioso-------------------------------------------------------------------//
	...
	public ResponseEntity<String> createLinkValioso(@RequestBody LinkValiosoDTO linkDTO) {
		...
		if (status == 0) {
			...
			return new ResponseEntity<>("Error al crear el link valioso, puede que el nombre ya esté en uso",
					HttpStatus.NOT_ACCEPTABLE);
		}
	}
