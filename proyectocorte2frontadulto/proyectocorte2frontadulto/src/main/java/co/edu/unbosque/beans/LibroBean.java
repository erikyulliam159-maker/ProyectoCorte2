...
public class LibroBean implements Serializable {
    ...
    public void init() {
        try {
            ...
            e.printStackTrace();
            // Puedes usar FacesContext para mostrar un mensaje si lo necesitas
        }
    }
    ...
    public void crearLibro() {
        try {
            // Validar que al menos uno de los campos PDF esté presente
            ...
            // SIEMPRE agregar el campo file, aunque sea vacío
            sb.append("--").append(boundary).append("\r\n");
            if (tieneArchivo) {
            ...
            // Escribir datos al output stream
            try (var os = conn.getOutputStream()) {
                os.write(inicio);
                
                // Escribir el archivo PDF solo si existe
                if (tieneArchivo) {
                ...
                // Si no hay archivo, no escribimos nada (archivo vacío)
 ...
 // Método para cargar el libro seleccionado en el formulario
 public void editarLibro(LibroDTO libro) {
     ...
     this.archivoPdf = null; // El archivo se carga solo si el usuario selecciona uno nuevo
 }

 // Método para guardar los cambios (actualizar)
 public void guardarEdicion() {
     try {
         ...
         // Si el usuario selecciona un nuevo archivo PDF
         sb.append("--").append(boundary).append("\r\n");
