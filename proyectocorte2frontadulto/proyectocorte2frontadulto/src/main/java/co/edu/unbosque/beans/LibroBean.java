...
public class LibroBean implements Serializable {
		...
		try {
			...
			if (!tieneArchivo) {
				FacesContext.getCurrentInstance().addMessage(null,
						new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error", "Debe proporcionar un archivo PDF"));
				return;
			} else if (!tieneUrl) {
				FacesContext.getCurrentInstance().addMessage(null,
						new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error", "Debe proporcionar una URL de PDF"));
				return;
			}
			...
			sb.append("Content-Disposition: form-data; name=\"imagenPortada\"\r\n\r\n")
					.append(libroSeleccionado.getImagenPortada() != null ? libroSeleccionado.getImagenPortada() : "")
					.append("\r\n");
			sb.append("--").append(boundary).append("\r\n");
	...
	public void editarLibro(LibroDTO libro) {
		this.libroSeleccionado = new LibroDTO(libro.getTitulo(), libro.getAutor(), libro.getAnio(),
				libro.getDescripcion(), libro.getImagenPortada(), libro.getPdf(), libro.getUrlpdf());
